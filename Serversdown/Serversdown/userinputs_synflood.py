...
def defineporttarget():
    awnseramount = int(raw_input('Enter the amount of open ports where through you want to attack your target: '))
    counter = 0
    targetports = []
    while counter < awnseramount:
          counter = counter + 1
          targetport = raw_input(str(counter) + '. Port: ')
